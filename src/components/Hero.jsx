      ...
      <div className="relative z-10 w-full">
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-16">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 text-sm font-medium mb-4 shadow-sm">
              ...
              <div className="mt-6 flex flex-wrap gap-4 text-sm text-gray-800">
                <div className="inline-flex items-center gap-2 bg-white/70 backdrop-blur px-3 py-1.5 rounded-full shadow">
              ...
              <div className="mt-8 flex items-center gap-6 text-gray-700">
                <div className="flex -space-x-2">
                  {[
                    ...
                    'https://images.unsplash.com/photo-1540190057400-4f78603f7bfd?q=80&w=200&auto=format&fit=crop',
            ...
            <div id="book">
              <div className="bg-white/90 backdrop-blur shadow-2xl rounded-2xl p-6 border border-emerald-100">
